...
\author{
\alignauthor
Jaspar, Jan, Sven, Stephan, Juliane, Nikolai\\
       \affaddr{Hasso Plattner Institute}\\
       \affaddr{Prof.-Dr.-Helmert-Str. 2-3}\\
       \affaddr{14482 Potsdam, Germany}\\
       \email{\footnotesize  \{Jaspar,Jan,Sven,Stephan,Juliane,Nikolai\}@student.hpi.de}
}
...
Entsprechend den Standard des 21 Jahrhunderts stellen wir ein REST Interface zur Steuerung und Interaktion mit unserer ``Core Engine'' zur Verfügung. Wir nutzen dieses REST Interface selbst für das Frontend und die Funktionalitäten die dort bereitgestellt werden.

--> Sven dein Beitrag. Wie sieht das REST Interface aus? Welche API keys, struktur, calls werden verwendet. Am besten mit Beispiel! thx :)
