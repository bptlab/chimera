...
public class ActivityRestService extends AbstractRestService {
	...
	public Response receiveActivityInstances(@PathParam("caseId") String caseId, @DefaultValue("") @QueryParam("filter") String filterString, @DefaultValue("") @QueryParam("state") String stateName) {
	...
	public Response receiveActivityInstance(@PathParam("caseId") String caseId, @PathParam("activityInstanceId") String activityInstanceId) {
		try {
			CaseExecutioner caseExecutioner = ExecutionService.getCaseExecutioner(caseId);
	...
	public Response updateDataObjects(@PathParam("caseId") String caseId, @PathParam("activityInstanceId") String activityInstanceId, List<UpdateDataObjectJaxBean> update) {
		try {
			CaseExecutioner caseExecutioner = ExecutionService.getCaseExecutioner(caseId);
			AbstractActivityInstance activityInstance = caseExecutioner.getActivityInstance(activityInstanceId);
