...
public class AndGatewayInstance extends GatewayInstance {
	...
	public AndGatewayInstance(int controlNodeId, int fragmentInstanceId, ScenarioInstance scenarioInstance) {
		...
		this.setControlNodeInstanceId(dbControlNodeInstance.createNewControlNodeInstance(controlNodeId, "AND", fragmentInstanceId, State.INIT));
		new Connector().insertGatewayInstance(getControlNodeInstanceId(), "AND", "init");
	 ...
	 *                           table.
	 */
	public AndGatewayInstance(int controlNodeId, int fragmentInstanceId, ScenarioInstance scenarioInstance, int instanceId) {
	...
	private void initGatewayInstance() {
		this.setOutgoingBehavior(new ParallelGatewaySplitBehavior(getControlNodeId(), scenarioInstance, getFragmentInstanceId(), this));
		this.setIncomingBehavior(new ParallelGatewayJoinBehavior(this, scenarioInstance));
