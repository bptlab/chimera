...
public class EndEventIncomingBehavior extends AbstractIncomingBehavior {
	 ...
	 */
	public EndEventIncomingBehavior(AbstractControlNodeInstance controlNodeInstance, ScenarioInstance scenarioInstance, boolean isSendEvent) {
	...
	public void enableControlFlow() {
		...
		getScenarioInstance().restartFragment(this.getControlNodeInstance().getFragmentInstanceId());
	}
}
