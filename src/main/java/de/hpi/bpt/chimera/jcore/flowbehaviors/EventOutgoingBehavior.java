...
public class EventOutgoingBehavior extends AbstractParallelOutgoingBehavior {
	...
	public EventOutgoingBehavior(int controlNodeId, ScenarioInstance scenarioInstance, int fragmentInstanceId, int controlNodeInstanceId) {
	...
	public void writeDataObjects(String eventJson) {
		DataAttributeWriter writer = new DataAttributeWriter(this.getControlNodeId(), controlNodeInstanceId, this.getScenarioInstance());
		List<DataAttributeInstance> attributeInstances = new ArrayList<>(this.getScenarioInstance().getDataManager().getDataAttributeInstances());
