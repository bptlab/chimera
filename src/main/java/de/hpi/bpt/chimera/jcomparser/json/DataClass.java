...
public class DataClass {
	...
	protected void generateDataAttributeList(JSONArray jsonAttributes) {
		...
		for (int i = 0; i < length; i++) {
			DataAttribute dataAttribute = new DataAttribute(jsonAttributes.getJSONObject(i).getString("name"), jsonAttributes.getJSONObject(i).getString("datatype"), jsonAttributes.getJSONObject(i).getString("_id"));
