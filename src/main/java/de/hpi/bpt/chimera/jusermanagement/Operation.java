package de.hpi.bpt.chimera.jusermanagement;
...
public class Operation {
    ...
    public static int insertRoleRow(String roleName, String description, Integer adminId) {
        String sql = "INSERT INTO `um_role` (`id` ,`rolename` ,`description` ,`admin_id`) VALUES (NULL , '"+roleName+"', '"+description+"', "+adminId+");";
    ...
    public static int insertUserRow(String userName, Integer roleId, String description) {
        String sql = "INSERT INTO `um_user` (`id` ,`username` ,`role_id` ,`description`) VALUES (NULL , '"+userName+"', "+roleId+", '"+description+"');";
        return Helper.executeInsertStatement(sql);
    }
    ...
    public static boolean updateRoleRow(int id, String roleName, String description, Integer adminId) {
        String sql = "UPDATE `um_role` SET `rolename` = '"+roleName+"', `description` = '"+description+"', `admin_id` = "+adminId+" WHERE id="+id+";";
    ...
    public static boolean updateUserRow(int id, String userName, Integer roleId, String description) {
        String sql = "UPDATE `um_user` SET `username` = '"+userName+"', `description` = '"+description+"', `role_id` = "+roleId+" WHERE id="+id+";";
        return Helper.executeUpdateStatement(sql);
    }
