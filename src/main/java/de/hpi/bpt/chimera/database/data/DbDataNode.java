...
public class DbDataNode extends DbObject {
	...
	public List<Integer> getDataStatesForDataSet(int dataSetId) {
		String sql = "Select state_id FROM datanode, datasetconsistsofdatanode " + "WHERE datanode.id = " + "datasetconsistsofdatanode.datanode_id " + "AND dataset_id = " + dataSetId + " ORDER BY dataclass_id";
	...
	public int getDataClassIdForDataNode(int dataNodeId) {
		String sql = "SELECT dataclass_id FROM datanode " + "WHERE datanode.id = %d";
	...
	public Map<Integer, Integer> getDataSetClassToStateMap(int dataSetId) {
		String sql = "SELECT dataclass_id, state_id " + "FROM datanode, datasetconsistsofdatanode " + "WHERE datanode.id = " + "datasetconsistsofdatanode.datanode_id " + "AND dataset_id = " + dataSetId + " ORDER BY dataclass_id";
