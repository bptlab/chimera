...
public class DbControlFlow extends DbObject {
	...
	public int getNextControlNodeAfterStartEvent(int controlNodeId) {
		String sql = "SELECT controlnode_id2 FROM controlflow " + "WHERE controlnode_id1 = " + controlNodeId;
	...
	public List<Integer> getPredecessorControlNodes(int controlNodeId) {
		String sql = "SELECT controlnode_id1 FROM controlflow " + "WHERE controlnode_id2 = " + controlNodeId;
	...
	public Map<Integer, String> getConditions(int controlNodeId) {
		String sql = "SELECT controlnode_id2, controlflow.condition " + "FROM controlflow " + "WHERE controlnode_id1 = " + controlNodeId;
