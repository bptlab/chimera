...
public class DbWebServiceTask extends DbObject {
	...
	public String getUrl(int controlNodeId) {
		String sql = "SELECT url FROM webservicetask " + "WHERE controlnode_id = " + controlNodeId;
	...
	public List<Integer> getAttributeIdsForControlNode(int controlNodeId) {
		String sql = "SELECT DISTINCT dataattribute_id FROM pathmapping " + "WHERE controlnode_id = " + controlNodeId;
	...
	public void updateWebServiceTaskUrl(int controlNodeId, String url) {
		String sql = "UPDATE webservicetask " + "SET url = '" + url + "' WHERE controlnode_id = " + controlNodeId;
	...
	public void updateWebServiceTaskMethod(int controlNodeId, String method) {
		String sql = "UPDATE webservicetask " + "SET method = '" + method + "' WHERE controlnode_id = " + controlNodeId;
		executeUpdateStatement(sql);
	}
	...
	public void updateWebServiceTaskBody(int controlNodeId, String body) {
		String sql = "UPDATE webservicetask " + "SET body = '%s' " + "WHERE controlnode_id = %d";
	...
	public void deleteWebServiceTaskAtribute(int controlNodeID, int dataAttributeID) {
		String sql = "DELETE FROM pathmapping " + "WHERE controlnode_id = " + controlNodeID + " AND dataattribute_id = " + dataAttributeID;
		executeUpdateStatement(sql);
	}
	...
	public List<Integer> getWebServiceTasks(int scenarioId) {
		String sql = "SELECT controlnode.id " + "FROM fragment, controlnode " + "WHERE fragment.id = controlnode.fragment_id " + "AND fragment.scenario_id = " + scenarioId + " " + "AND controlnode.type = 'WebServiceTask'";
	...
	public String getMethod(int controlNodeId) {
		String sql = "SELECT method FROM webservicetask " + "WHERE `controlnode_id` = " + controlNodeId;
	...
	public String getPOSTBody(int controlNodeId) {
		String sql = "SELECT body FROM webservicetask " + "WHERE `controlnode_id` = " + controlNodeId;
	...
	public boolean doesWebServiceTaskHaveBody(int controlNodeId) {
		String sql = "SELECT * FROM webservicetask " + "WHERE controlnode_id = %d " + "AND body <> NULL " + "AND body <> ''";
	...
	public Map<Integer, String> getOutputAttributesForWebservice(int webserviceNodeId) {
		String sql = "SELECT dataattribute.id as did, dataattribute.name as dname" + " FROM pathmapping, dataattribute " + "WHERE pathmapping.controlnode_id = %d " + "AND dataattribute.id = pathmapping.dataattribute_id";
