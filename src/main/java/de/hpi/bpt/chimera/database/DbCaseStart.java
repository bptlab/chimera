...
public class DbCaseStart extends DbEventMapping {
	 ...
	 */
	public void insertCaseStartMapping(String requestId, int scenarioId, String notificationRuleId, String queryId) {
		String sql = "INSERT INTO casestart (eventkey, notificationrule_id, scenario_id, query_id)" + " VALUES ('%s', '%s', %d, '%s')";
