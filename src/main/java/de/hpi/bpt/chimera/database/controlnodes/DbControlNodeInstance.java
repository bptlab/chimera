...
public class DbControlNodeInstance extends DbObject {
	...
	public Boolean existControlNodeInstance(int controlNodeId, int fragmentInstanceId) {
		String sql = "SELECT id FROM controlnodeinstance " + "WHERE controlnode_id = " + controlNodeId + " " + "AND fragmentinstance_id = " + fragmentInstanceId;
	...
	public Boolean existControlNodeInstance(int id) {
		String sql = "SELECT id FROM controlnodeinstance " + "WHERE id = " + id;
		return executeExistStatement(sql);
	}
	 ...
	 */
	public int createNewControlNodeInstance(int controlNodeId, String controlNodeType, int fragmentInstanceId, State state) {
		String sql = "INSERT INTO controlnodeinstance (Type, controlnode_id, " + "fragmentinstance_id, state) VALUES ('%s', %d, %d, '%s')";
		sql = String.format(sql, controlNodeType, controlNodeId, fragmentInstanceId, state.name());
		return executeInsertStatement(sql);
	}

	public List<Integer> getControlNodeInstances(int scenarioInstanceId) {
		String sql = "SELECT * FROM controlnodeinstance as cni, fragmentinstance as f WHERE " + "cni.fragmentinstance_id = f.id AND " + "f.scenarioinstance_id = %d;";
	...
	public int getFragmentInstanceId(int controlNodeInstanceId) {
		String sql = "SELECT * FROM controlnodeinstance as cni WHERE " + "cni.id = %d;";
	...
	public List<Integer> getActivitiesForFragmentInstanceId(int fragmentInstanceId) {
		String sql = "SELECT controlnode_id FROM controlnodeinstance " + "WHERE controlnodeinstance.Type = 'Activity' " + "AND fragmentinstance_id = " + fragmentInstanceId;
	 ...
	 */
	public List<Integer> getActivityInstancesForFragmentInstanceID(int fragmentInstanceId) {
		String sql = "SELECT id FROM controlnodeinstance " + "WHERE controlnodeinstance.Type = 'Activity' " + "AND fragmentinstance_id = " + fragmentInstanceId;
	...
	public List<Integer> getGatewaysForFragmentInstanceID(int fragmentInstanceId) {
		String sql = "SELECT controlnode_id FROM controlnodeinstance " + "WHERE (controlnodeinstance.Type = 'AND' " + "OR controlnodeinstance.Type = 'XOR'" + "OR controlnodeinstance.Type = 'EVENT_BASED') " + "AND fragmentinstance_id = " + fragmentInstanceId;
		return this.executeStatementReturnsListInt(sql, "controlnode_id");
	}
	...
	public int getControlNodeId(int id) {
		String sql = "SELECT controlnode_id FROM controlnodeinstance WHERE id = " + id;
	 ...
	 */
	public List<Integer> getGatewayInstancesForFragmentInstanceId(int fragmentInstanceId) {
		String sql = "SELECT id FROM controlnodeinstance " + "WHERE (controlnodeinstance.Type = 'AND' " + "OR controlnodeinstance.Type = 'XOR'" + "OR controlnodeinstance.Type = 'EVENT_BASED') " + "AND fragmentinstance_id = " + fragmentInstanceId;
		return this.executeStatementReturnsListInt(sql, "id");
	}
