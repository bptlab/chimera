...
public class DbDataAttributeInstance extends DbObject {
	...
	public int createNewDataAttributeInstance(int dataAttributeId, int dataObjectId) {
		String sql = "INSERT INTO dataattributeinstance (" + "value, dataobject_id, dataattribute_id) " + "VALUES ((SELECT dataattribute.default " + "FROM dataattribute WHERE id = " + dataAttributeId + "), " + dataObjectId + ", " + dataAttributeId + ")";
	...
	public Boolean existDataAttributeInstance(int dataAttributeId, int dataObjectId) {
		String sql = "SELECT id FROM dataattributeinstance " + "WHERE dataobject_id = " + dataObjectId + " " + "AND dataattribute_id = " + dataAttributeId;
	...
	public Boolean existDataAttributeInstance(int id) {
		String sql = "SELECT id FROM dataattributeinstance " + "WHERE id = %d";
	...
	public Object getValue(int id) {
		String sql = "SELECT value FROM dataattributeinstance " + "WHERE id = " + id;
	...
	public int getDataObjectId(int id) {
		String sql = "SELECT dataobject_id FROM dataattributeinstance " + "WHERE id = %d";
		return this.executeStatementReturnsInt(String.format(sql, id), "dataobject_id");
	}
	...
	public void setValue(int id, Object value) {
		String sql = "UPDATE dataattributeinstance SET value = '" + value + "' WHERE id = " + id;
	...
	public int getDataAttributeID(int id) {
		String sql = "SELECT dataattribute_id FROM dataattributeinstance WHERE id = " + id;
	...
	public List<Integer> getAttributeInstanceIdsForDataObject(int dataObjectId) {
		String getDataAttributes = "SELECT id FROM dataattributeinstance " + "WHERE dataobject_id = %d;";
