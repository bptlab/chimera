...
public class DebugClass {
	...
	public static void main(String[] args) {
		...
		while (true) {
			Collection<ActivityInstance> acts = executionService
					.getEnabledActivities(scenarioInstanceID);
			...
			executionService.setDataAttributeValues(scenarioInstanceID, read,
