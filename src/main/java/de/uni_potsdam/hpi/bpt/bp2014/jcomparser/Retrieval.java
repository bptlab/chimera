...
public class Retrieval {
	 ...
	 */
	private final String loginRequest = "<user>%n" + "<property name='name' value='%s'/>%n"
			+ "<property name='pwd' value='%s'/>%n" + "</user>";
	/**
	...
	private InputStream getInputStream(String hosturl, String urlToRead)
		...
		HttpURLConnection modelsConnection = (HttpURLConnection) new URL(urlToRead)
				.openConnection();
