...
public class DbDataObjectInstance extends DbObject {
	...
	public Boolean existDataObjectInstance(int scenarioInstance_id, int dataObject_id) {
		String sql = "SELECT id FROM dataobjectinstance WHERE scenarioinstance_id = "
				+ scenarioInstance_id + " AND dataobject_id = " + dataObject_id;
	 ...
	 */
	public int createNewDataObjectInstance(int scenarioInstance_id, int state_id,
			int dataObject_id) {
		String sql =
				"INSERT INTO dataobjectinstance (scenarioinstance_id, state_id, dataobject_id) VALUES ("
	...
	public int getDataObjectInstanceID(int scenarioInstance_id, int dataObject_id) {
		String sql = "SELECT id FROM dataobjectinstance WHERE dataobject_id = " + dataObject_id
	...
	public void setOnChange(int id, Boolean onChange) {
		...
		String sql =
				"UPDATE dataobjectinstance SET onchange = " + onChangeAsInt + " WHERE id = " + id;
		this.executeUpdateStatement(sql);
	}
	...
	public int getDataObjectID(int dataObjectInstanceID) {
		String sql =
				"SELECT dataobject_id FROM dataobjectinstance WHERE id = " + dataObjectInstanceID;
