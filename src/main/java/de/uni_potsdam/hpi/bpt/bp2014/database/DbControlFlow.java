...
public class DbControlFlow extends DbObject {
	...
	public int getNextControlNodeAfterStartEvent(int controlNode_id) {
		String sql =
				"SELECT controlnode_id2 FROM controlflow WHERE controlnode_id1 = " + controlNode_id;
	...
	public LinkedList<Integer> getPredecessorControlNodes(int controlNode_id) {
		String sql =
				"SELECT controlnode_id1 FROM controlflow WHERE controlnode_id2 = " + controlNode_id;
	...
	public Map<Integer, String> getConditions(int controlNode_id) {
		String sql =
				"SELECT controlnode_id2, controlflow.condition FROM controlflow WHERE controlnode_id1 = "
						+ controlNode_id;
