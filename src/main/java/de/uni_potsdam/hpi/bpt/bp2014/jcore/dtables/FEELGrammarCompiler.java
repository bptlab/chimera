 ...
 *
 */
public class FEELGrammarCompiler {
    /**
     * @param expression
     * @return
     */
    public CommonTree compile(String expression) {
        try {
            ...
            TokenStream tokens = new CommonTokenStream(new FEELGrammarLexer(input));

            //parser generates abstract syntax tree
            FEELGrammarParser parser = new FEELGrammarParser(tokens);
            FEELGrammarParser.expr_return ret = parser.simple_expression();
